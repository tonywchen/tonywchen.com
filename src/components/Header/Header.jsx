          ...
          <div className="brand-logo">
            <svg viewBox="0 0 192 76">
              <g fill="#1f282d">
                ...
                <circle id="Oval" fillRule="nonzero" cx="183" cy="50" r="6"></circle>
              </g>
            </svg>
          </div>
          <div className="nav-toggle pull-right d-lg-none" onClick={toggleCollapsed}>
            <svg viewBox="0 0 24 24">
              <path d="M4.13503329,8.28388044 L11.9582566,16.1071037 C12.0558877,16.2047348 12.2141789,16.2047348 12.31181,16.1071037 L20.1350333,8.28388044" strokeWidth="2" strokeLinecap="round" fill="none"></path>
            </svg>
          </div>
        </Container>
      </div>
