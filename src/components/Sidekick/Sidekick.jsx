...
const Sidekick = ({ tags, inline, silent, times, delay, force, invert }) => {
  ...
  const sidekickClassNameList = ['sidekick'];
  if (inline) {
    sidekickClassNameList.push('sidekick--inline');
  }
  if (invert) {
    sidekickClassNameList.push('sidekick--invert');
  }

  const sidekickClassNames = sidekickClassNameList.join(' ');
